<template>
  <div id="HomePage">
    ...
    <el-dialog
      ...
      width="30%"
    >
      <li><span class="glyphicon glyphicon-earphone"></span>18707649xxx</li>
      <li><span class="glyphicon glyphicon-envelope"></span>1039137xxx@qq.com</li>
    ...
    <div id="customer" class="container-fuild">
      <div class="container customer-container">
        <p class="customer-title text-center">走马灯</p>
      ...
      serverList: [
        {
          ...
          title: "核心优势1",
          content: "<p>态度务实端庄，性格开朗</p>具有抗压能力和团队合作精神",
        },
        {
          logo: require("@/assets/img/computer.png"),
          title: "核心优势2",
          content:
            "<p>具有良好的代码习惯</p>能编写出高效、可维护性的代码",
        },
        {
          logo: require("@/assets/img/qq.png"),
          title: "核心优势3",
          content:
            "<p>热爱学习，具有上进心</p>喜欢学习新技术",
        },
        {
          logo: require("@/assets/img/skill.png"),
          title: "核心优势4",
          content: "<p>两年多的前端工作经验</p>遇到问题会通过各种方法解决",
        },
      ],
      dialogVisible: false,
    };
...
/* 媒体查询（平板） */
@media screen and (min-width: 810px) and (max-width: 996px) {
  #swiper {
    height: 400px;
  }
  #bigData {
